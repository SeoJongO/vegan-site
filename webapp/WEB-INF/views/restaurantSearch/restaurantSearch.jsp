               ...
               <div id="menu_wrap" class="bg_white">
                  ...
                  <c:forEach items="${storeList}" var="storeVo">
                     <div class="clearfix s_div" data-address="${storeVo.s_address}" data-no="${storeVo.s_no}"
                        ...
                        <img style="width: 90px; height: 90px;" src="${pageContext.request.contextPath}/veganLogo/${storeVo.s_img}"  id="s_img">
                        <p><b>${storeVo.s_name}</b> ${storeVo.avg}<img src="${pageContext.request.contextPath}/assets/image/star.png"> </p>
                        <%-- <p>${storeVo.s_phone}</p> --%>
                        <p>${storeVo.s_address},${storeVo.s_detail_address}</p>
                        <%-- <p>${storeVo.s_parking}</p> --%>
