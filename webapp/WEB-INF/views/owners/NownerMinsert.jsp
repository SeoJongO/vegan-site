							...
							<form action="${pageContext.request.contextPath}/owners/menuInsert" method="post" enctype="multipart/form-data">
								<table class="main-table">
									...
									<tr>
										...
										<td class="bnone"><select id="menuType" name="m_type">
										...
										</select> <span class="button-area orange">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<img alt="" src="${pageContext.request.contextPath }/assets/image/KakaoTalk_Photo_2021-10-16-23-08-41 006.png"> <br> <br> <br> <span class="borange">채식 타입 테스트하기</span> <br> <br> <span>간단한 테스트를 통해</span><br> <span> 메뉴의 채식타입을 설정할 수 있어요! </span><br> <span>(기본적으로 육류는 허용되지 않습니다. 치킨스톡 등 육수도 안돼요!)</span> <br> <br> <br>
						</div>
						<div class="form-group"></div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn mbtn" id="btnUpload" onclick="first()">시작하기</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span class="bold">질문 1</span> <br> <br> <br> <span>메뉴에 해산물이 들어있나요?<br> (고등어, 갈치, 새우, 해조류..등)
							</span> <br> <br> <br>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span>이 메뉴의 채식타입은</span> <span class="bold">페스코</span> <span>입니다.</span><br>
							<br>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span class="bold">질문 2</span> <br> <br> <span>매뉴의 알을 들어있나요?<br> (계란, 메추리알)
							</span><br> <br> <br>
						</div>
						<div class="form-group"></div>
					</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span class="bold">질문 3</span> <br> <br> <span>메뉴에 유제품이 들어있나요?<br> (우유, 치즈, 요거트)
							</span><br>
							<br>
							<br>
						</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span>이 메뉴의 채식타입은</span> <span class="bold">락토-오보</span> <span>입니다.</span><br>
							<br>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span>이 메뉴의 채식타입은</span> <span class="bold">오보</span> <span>입니다.</span><br>
							<br>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span>이 메뉴의 채식타입은</span> <span class="bold">락토</span> <span>입니다.</span><br>
							<br>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form method="post" action="" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="form-group">
							<span>이 메뉴의 채식타입은</span> <span class="bold">비건</span> <span>입니다.</span><br>
							<br>
